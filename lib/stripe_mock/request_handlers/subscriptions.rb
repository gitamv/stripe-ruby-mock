  ...
  module RequestHandlers
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        allowed_params = %w(customer application_fee_percent billing billing_cycle_anchor days_until_due coupon items metadata plan quantity source tax_percent trial_end trial_period_days current_period_start created prorate)
