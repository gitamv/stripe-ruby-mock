...
shared_examples 'Invoice API' do
  ...
  context "retrieving upcoming invoice" do
    ...
    let(:plan)          { @teardown_plan = true; Stripe::Plan.create(id: '50m', amount: 50_00, interval: 'month', name: '50m', currency: 'usd', product: 'pr_test00001') }
    let(:quantity)      { 3 }
    ...
    describe 'proration' do
      ...
      [false, true].each do |with_trial|
        describe "prorating a subscription with a new plan, with_trial: #{with_trial}" do
          let(:new_monthly_plan) { @teardown_monthly_plan = true; Stripe::Plan.create(id: '100m', amount: 100_00, interval: 'month', name: '100m', currency: 'usd', product: 'pr_test00001') }
          let(:new_yearly_plan) { @teardown_yearly_plan = true; Stripe::Plan.create(id: '100y', amount: 100_00, interval: 'year', name: '100y', currency: 'usd', product: 'pr_test00001') }
